    ...
    return (
        <div className="overflow-hidden" id="portfolio">
            <div className="relative min-h-screen w-screen bg-[#f4f4f4] pt-32">
                <div className="w-full relative flex items-center min-h-screen">
                    <div className="z-[1] w-full flex flex-col mx-auto">
                        <h2 className="text-center text-[#6C00E6] font-extrabold text-6xl pb-10">
                            Nuestro Portafolio
                        </h2>
                        ...
                        <div className="z-[-1] relative h-[1200px] flex justify-center">
